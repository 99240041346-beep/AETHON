...
public final class MainActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    private void buildUi() {
        ...
        cc.addView(label("Conversation",18));
        messages=new LinearLayout(this);messages.setOrientation(LinearLayout.VERTICAL);cc.addView(messages,new LinearLayout.LayoutParams(-1,-2));
        ...
        LinearLayout lang=new LinearLayout(this);lang.setOrientation(LinearLayout.HORIZONTAL);lang.setPadding(dp(14),dp(10),dp(14),dp(10));lang.setBackground(card());root.addView(lang,new LinearLayout.LayoutParams(-1,-2));lang.addView(label("Language: Auto • Telugu + English",14),new LinearLayout.LayoutParams(0,-2,1));
        Button health=button("✓  API");health.setOnClickListener(v->checkHealth());lang.addView(health,new LinearLayout.LayoutParams(dp(90),dp(46)));
        TextView info=label("Device: "+Build.MANUFACTURER+" "+Build.MODEL+" • Android "+Build.VERSION.RELEASE+"\n🔒 Safety Kernel active • actions are allowlisted",12);info.setTextColor(Color.rgb(148,163,184));root.addView(info);
    }
